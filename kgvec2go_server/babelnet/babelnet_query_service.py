...
class BabelNetQueryService:
    ...
    def get_similarity(self, concept_1: str, concept_2: str, pos_1: str = 'n', pos_2: str = 'n') -> float:
    ...
    def get_similarity_json(self, concept_1: str, concept_2: str, pos_1: str = 'n', pos_2: str = 'n'):
        """Calculate the similarity between the two given concepts.
